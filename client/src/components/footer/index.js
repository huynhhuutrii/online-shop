    ...
    return (
      <div className={styles.container}>
        <div className={styles.row}>
          ...
          <div>
            BẠN ĐANG BĂN KHOĂN VỀ THIẾT KẾ NỘI THẤT VÀ MUỐN TÌM HIỂU THÊM THÔNG
            TIN?
          </div>
        </div>
        <div className={styles.col}>
          <div className={styles.col1}>
            ...
            <div style={{ fontWeight: '500' }}>
              Chủ quản:<span style={{ fontWeight: 'normal' }}>Trí Jerry</span>
            </div>
            <div style={{ fontWeight: '500' }}>
              {' '}
              Mã số doan nghiệp:
              <span style={{ fontWeight: 'normal' }}>0920389208</span>
            </div>

            <div style={{ fontWeight: '500' }}>
              Trụ sở:
              <span style={{ fontWeight: 'normal' }}>
                1/199,Hòa Lân 2, Thuận Giao, Thuận An, Bình Dương
              </span>
            </div>
            <div style={{ fontWeight: '500' }}>
              Hotline:
              <span style={{ fontWeight: 'normal' }}>
                0969060473 <span>-</span>
              </span>
              <span style={{ fontWeight: '500' }}>Email:</span>
              <span style={{ fontWeight: 'normal' }}>
                huynhtri2k11@gamil.com
              </span>{' '}
            </div>
          </div>
